...
/**
 * A report class for tracking and managing broken links found during Synthetics canary execution.
 * Provides methods to add links, track their status, and generate summary statistics.
 */
declare class BrokenLinkCheckerReport {
    /**
